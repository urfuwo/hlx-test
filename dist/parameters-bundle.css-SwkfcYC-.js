...
const insertMainFontFace = () => {
  if (!hasStyle("data-ui5-font-face")) {
    createStyle(styleData$4, "data-ui5-font-face");
  }
};
const insertOverrideFontFace = () => {
  if (!hasStyle("data-ui5-font-face-override")) {
    createStyle(styleData$3, "data-ui5-font-face-override");
  }
};
const styleData$2 = {
  packageName: "@ui5/webcomponents-base",
...
const insertSystemCSSVars = () => {
  if (!hasStyle("data-ui5-system-css-vars")) {
    createStyle(styleData$2, "data-ui5-system-css-vars");
  }
};
 ...
 */
var t$1;
const i$1 = window, s = i$1.trustedTypes, e$2 = s ? s.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$1 = "$lit$", n = `lit$${(Math.random() + "").slice(9)}$`, l$1 = "?" + n, h = `<${l$1}>`, r = document, u = () => r.createComment(""), d = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c = Array.isArray, v = (t2) => c(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a = "[ 	\n\f\r]", f = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _ = /-->/g, m = />/g, p = RegExp(`>|${a}(?:([^\\s"'>=/]+)(${a}*=${a}*(?:[^ 	
...
const V = (t2, i2) => {
  ...
  for (let i3 = 0; i3 < s2; i3++) {
    ...
    r2 += u2 === f ? s3 + h : v2 >= 0 ? (e2.push(d2), s3.slice(0, v2) + o$1 + s3.slice(v2) + n + w2) : s3 + n + (-2 === v2 ? (e2.push(void 0), i3) : w2);
  }
      ...
      if (1 === h2.nodeType) {
        if (h2.hasAttributes()) {
          ...
          for (const i3 of h2.getAttributeNames())
            if (i3.endsWith(o$1) || i3.startsWith(n)) {
              const s2 = f2[d2++];
...
const j = { O: o$1, P: n, A: l$1, C: 1, M: V, L: M, R: v, D: S, I: R, V: k, H: L, N: z, U: H, F: Z }, B = i$1.litHtmlPolyfillSupport;
...
export {
  ...
  j as I,
  getTheme as J,
  executeTemplate as K,
  T,
  UI5Element as U,
  registerThemePropertiesLoader as a,
  b,
  styleData$1 as c,
  styleData as d,
  effectiveHtml as e,
  customElement as f,
  getScopedVarName as g,
  getFeature as h,
  isLegacyThemeFamily as i,
  isAndroid as j,
  isPhone as k,
  l,
  getI18nBundle as m,
  ...
  property as p,
  e$1 as q,
  registerFeature as r,
  scopeTag as s,
  i as t,
  t as u,
  instanceOfUI5Element as v,
  getSharedResource as w,
  x,
  hasStyle as y,
  createStyle as z
};
