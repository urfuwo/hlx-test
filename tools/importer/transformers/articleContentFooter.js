...
const articleContentFooter = (main, document) => {
  const footnoteParagraph = document.querySelector('section#main > article div.entry-content p.has-small-font-size:last-child, section#main > article div.entry-content p > small');
